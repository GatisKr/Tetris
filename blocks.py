...
# Create child classes, one for each block.
class LBlock(Block): # This block inherits the attributes and methods of the Block class. We declare that inside the parenthesis LBlock(Block). The LBlock class is a child of the block class.
